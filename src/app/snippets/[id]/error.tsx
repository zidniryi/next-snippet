...
export default function Error({
	...
	useEffect(() => {
		console.error('Snippet detail error:', error);
	}, [error]);
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="bg-white rounded-lg shadow-sm border border-red-200 p-6">
					<div className="text-center">
						...
						<h2 className="mt-4 text-lg font-medium text-gray-900">Failed to load snippet</h2>
						<p className="mt-2 text-sm text-gray-600">
							There was an error loading the snippet. This might be due to a network issue or the snippet might not exist.
						</p>
